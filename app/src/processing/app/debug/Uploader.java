...
{
    static final String BUGS_URL                            = _("https://developer.berlios.de/bugs/?group_id=3590");
    ...
    public abstract boolean uploadUsingPreferences(String buildPath, String className, boolean usingProgrammer) throws RunnerException, SerialException;
    ...
    protected boolean executeUploadCommand(Collection commandDownloader) throws RunnerException
    {
        ...
        catch (Exception e)
        {
          ...
          if ((msg != null) && (msg.indexOf("uisp: not found") != -1) && (msg.indexOf("avrdude: not found") != -1) && (msg.indexOf("avrxprog: not found") != -1))
          {
              return false;
          }
          else
